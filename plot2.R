...
plot(totalEmissionsBaltimore$year,totalEmissionsBaltimore$total,xlab="Year",ylab="Total Emissions",type="l",main = "Total Emissions in Baltimore City from 1999 to 2008")
dev.off()
